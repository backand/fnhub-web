...
<div class="container page-module-detail">
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="page-content m-t-md text-gray-lt">{!! $detail !!}
      </div> 
    </div>
        ...
        <div class="sidebar-item">
          <ul class="list small sidebar-list">
            ...
            <li class="list-item">
              ...
              <div class="list-body">
                <a href="{{$module['githubRepo']}}" target="_blank" class="_600">{{$module['githubRepo']}}</a>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="sidebar-item">
          ...
          <ul class="nav flex-column">
            @foreach ($languages as $language)
              <li class="nav-item">
                <span class="nav-link {{ $language['key'] == strtolower($module['language']) ? 'text-primary' : '' }}">   @if ($language['key'] == strtolower($module['language'])) <i class="fa fa-caret-right" aria-hidden="true" ></i> @endif  {{$language['name']}}</span>
              </li>
            @endforeach
          </ul>
        </div>
